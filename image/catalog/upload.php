...
class ControllerToolUpload extends Controller {
	...
	public function plupload()
	{
		...
		*/
		...
		// Settings
		$targetDir = DIR_IMAGE;// ini_get("upload_tmp_dir") . DIRECTORY_SEPARATOR . "plupload";

		if (isset($_REQUEST['directory'])) {
			$targetDir .= DIRECTORY_SEPARATOR.$_REQUEST['directory'];
		}
		//$targetDir = 'uploads';
		...
		if (!$out = @fopen("{$filePath}.part", $chunks ? "ab" : "wb")) {
			die('{"jsonrpc" : "2.0", "error" : {"code": 102, "message": "Failed to open output stream.'.$filePath'"}, "id" : "id"}');
		}
		...
		die('{"jsonrpc" : "2.0", "result" : null, "fileName" : "'.$fileName.'" , "id" : "id"}');
