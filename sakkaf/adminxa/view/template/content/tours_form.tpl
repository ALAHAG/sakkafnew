        ...
        <div class="panel-body">
          <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
            <div class="tab-content">
              ...
              <div class="form-group ">
                <label class="col-sm-2 control-label" for="input-title_en">Customer Price (RM)</label>
                <div class="col-sm-10">
                  <input type="text" name="selprice" value="<?php echo isset($selprice) ? $selprice : ''; ?>" placeholder="Price " id="input-price" class="form-control" />
                  <?php if (isset($error_price)) { ?>
                  <div class="text-danger"><?php echo $error_price; ?></div>
                  <?php } ?>
                </div>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-fromCity<?php echo $language['language_id']; ?>">From : </label>
                    <div class="col-sm-3">
                      <input type="text" name="fromCity" value="<?php echo isset($fromCity) ? $fromCity : ''; ?>" placeholder="من " id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                    <label class="col-sm-2 control-label" for="input-toCity<?php echo $language['language_id']; ?>">To : </label>
                    <div class="col-sm-3">
                      <input type="text" name="toCity" value="<?php echo isset($toCity) ? $toCity : ''; ?>" placeholder="من " id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                   <label class="col-sm-2 control-label" for="carType">Type of Car </label>
                   <div class="col-sm-10">
                     <select name="carType" id="carType" class="form-control">
                       <option value="">choose car Type</option>
                       <option value="سيارة" <?php echo "سيارة" == $carType ?"selected" : '' ?> >سيارة</option>
                       <option value="MPV" <?php echo "MPV" == $carType ?"selected" : '' ?> >MPV</option>
                       <option value="VAN" <?php echo "VAN" == $carType ?"selected" : '' ?> >VAN</option>
                     </select>
                   </div>
                 </div>
                  <div class="form-group">
