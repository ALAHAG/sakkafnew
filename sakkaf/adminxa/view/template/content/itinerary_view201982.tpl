...
.company-details {
  ...
  <?php } else { ?>
    ...
    <tr>
            ...
            <td class="col company-details"  style="text-align: left;    font-size: 12px;">
                ...
                <div>sales-2@alsakkaftravel.com</div>
            </td></tr>
  ...
  <tbody>
    <tr>
    <td class="tb_col" style="padding:0em 1em">  <b><?php echo $itinerary_title; ?></b></td>
    <td class="tb_col">   <?php echo (isset($itinerary_rooms) && $itinerary_rooms )?'نعم': 'لا' ;?> </td>
    <td class="tb_col">   <?php echo (isset($itinerary_transportations) && $itinerary_transportations)?'نعم': 'لا' ;?> </td>
    <td class="tb_col">   <?php echo (isset($itinerary_tours) && $itinerary_tours )?'نعم': 'لا' ;?> </td>
...
?>
  ...
  <!--           <td style="border:1px solid #CED0D1;text-align:center;padding:1.5em 1px; font-weight: bold;"> *<?php echo $room['star_rate'] ;?> </td>
   ...
   <?php foreach ($itinerary_transportations as $transportation): ?>
    ...
    <tbody>
      <tr>
        <td class="tb_col" style="text-align: center;padding:10px;font-weight:bold;    font-size: 1.7em !important;color:#7B0462;">   <?php echo $customer_price ?>    <?php echo $currancy[$currancy_type];?> </td>
      <td class="tb_col" style="text-align: center;padding:10px;font-weight:bold;    font-size: 1.7em !important;color:#7B0462;">    <?php echo ceil($downpayment) ?> <?php echo $currancy[$currancy_type];?> </td>
