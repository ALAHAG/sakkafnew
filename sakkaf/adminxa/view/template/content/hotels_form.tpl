    ...
    <div class="container-fluid">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $text_form; ?></h3> - <span><?php echo $hotel_english_name; ?></span>
        </div>
        <div class="panel-body">
          <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
            <div class="tab-content">
              <div class="form-group ">
                <label class="col-sm-2 control-label" for="input-hotel_english_name"><?php echo $entry_hotel_english_name; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="hotel_english_name" value="<?php echo isset($hotel_english_name) ? $hotel_english_name : ''; ?>" placeholder="<?php echo $entry_hotel_english_name; ?>" id="input-hotel_english_name" class="form-control" />
                  <?php if (isset($error_hotel_english_name)) { ?>
                  <div class="text-danger"><?php echo $error_hotel_english_name; ?></div>
                  <?php } ?>
                </div>
              </div>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="hotel_description[<?php echo $language['language_id']; ?>][hotel_name]" value="<?php echo isset($hotel_description[$language['language_id']]) ? $hotel_description[$language['language_id']]['hotel_name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="hotel_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($hotel_description[$language['language_id']]) ? $hotel_description[$language['language_id']]['description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
              ...
              <div class="form-group ">
                <label class="col-sm-12"> <div class="panel-heading">
                  <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $entry_images; ?></h3></div>
                </div>
                <div class="col-md-12">
                  <div class="row">
                    <div id="images">
                      <?php if ($hotel_images): ?>
                        <?php foreach ($hotel_images as $key => $image): ?>
                          <div id="<?php echo $key ?>" class="col-sm-3">
                            <img src="../../image/<?php echo $image['image'] ?>" width="100%" >
                            <div class="form-group">
                              <input type="hidden" class="cover" name="hotel_images[<?php echo $key ?>][image]" value="<?php echo $image['image'] ?>" >
                              <label class="col-sm-6 control-label" for="input-cover">
                                <input type="checkbox" class="cover" name="hotel_images[<?php echo $key ?>][cover]" <?php echo $image['cover'] ? 'checked' : ''?> value="1" ></input><?php echo $entry_cover; ?>
                              </label>
                              <div class="col-sm-4">
                    ...
                    <div class="row" >
                      ...
                      <!-- <div class="form-group  col-sm-12"> -->
                        ...
                        <div class="col-sm-3 input-group">
                          <input type="text" name="hotel_room[<?php echo $room_row; ?>][price]"  value="<?php echo $room['r_price'] ?>"  placeholder="Room Price" class="form-control " />
                          <?php if (isset($error_room_english_name) && $error_room_english_name) { ?>
                          <div class="text-danger"><?php echo $error_room_english_name; ?></div>
                          <?php } ?>
                        </div>
  ...
  init: {
   ...
   UploadProgress: function(up, file) {
    ...
    FileUploaded: function(up, file,res) {
      ...
      +'<div class="form-group">'
      +'<input type="hidden" class="cover" name="hotel_images['+counter+'][image]" value="'+directory+'/'+response.fileName+'" >'
      +'<label class="col-sm-6 control-label" for="input-cover">'
      +'<input type="checkbox" class="cover" name="hotel_images['+counter+'][cover]" value="1" ></input><?php echo $entry_cover; ?>'
      +'</label>'
      +'<div class="col-sm-4">'
...
$('#slug').focus(function  () {
  if (this.value == '') {
    $(this).val(getSlug($('[name="hotel_english_name"]').val()));
    updateSlug();
  };
})
