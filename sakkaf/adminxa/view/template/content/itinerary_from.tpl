...
<div id="content">
  ...
  $( document ).ready(function() {
    $('[name="itinerary_notes"]').summernote();
     ...
     $(document.body).on('keyup','.price', function () {
      checkTotalPrice();
      })
      $(document.body).on('keyup','.mprice', function () {
       checkTotalPrice();
     })
          ...
          var hotel = '<div id="itinerary_element'+counter+'" class="itinerary_element row">'
                ...
                hotel +=  '</div>'
                            ...
                            +'<div class="form-group col-lg-3 col-md-6">'
                              +'<label class="col-sm-6 control-label" for="num_of_nights"><?php echo $entry_num_of_nights; ?></label>'
                              +'<div class="col-sm-6">'
                                +'<input name="room['+counter+'][num_of_nights]" value="0" class="nnights mprice form-control">'
                              +'</div>'
                            +'</div>'
                            +'<div class="form-group col-lg-3 col-md-6">'
                              +'<label class="col-sm-6 control-label" for="start_day"><?php echo $entry_start_day; ?></label>'
                            ...
                            +'<div class="form-group col-lg-3 col-md-6">'
                              +'<label class="col-sm-6 control-label" for="price"><?php echo $entry_price; ?></label>'
                              +'<div class="col-sm-6">'
                                +'<input id="price_room'+counter+'" name="room['+counter+'][price]" value="" class="mprice form-control">'
                                +'<input name="room['+counter+'][order]" id="sort_order_'+counter+'" type="hidden" value="'+counter+'">'
                              +'</div>'
                              +'<label class="col-sm-6 control-label" for="price">Total Price</label>'

                            +'<div class="col-sm-6">'
                              +'<input id="" name="room['+counter+'][subtotal]" value="" class="price  form-control" readonly>'
                              +'<input type="hidden" id="'+counter+'" name="subtotal" value="'+counter+'" class="subtotal form-control">'
                            +'</div>'
                            +'</div>'
