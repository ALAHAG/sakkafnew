    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-country" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-name">الدولة</label>
            <div class="col-sm-10">
              <input type="text" name="name_ar" value="<?php echo $name_ar; ?>" placeholder="الدولة " id="input-name" class="form-control" />
            </div>
          </div>
