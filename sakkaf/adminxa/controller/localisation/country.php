...
class ControllerLocalisationCountry extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['countries'][] = array(
				...
				'name_ar'       => $result['name_ar'] . (($result['country_id'] == $this->config->get('config_country_id')) ? $this->language->get('text_default') : null),
	...
	protected function getForm() {
		...
		if (isset($this->request->post['name_ar'])) {
			$data['name_ar'] = $this->request->post['name_ar'];
		} elseif (!empty($country_info)) {
			$data['name_ar'] = $country_info['name_ar'];
		} else {
			$data['name_ar'] = '';
		}
