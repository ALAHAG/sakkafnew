...
class ControllerContentPage extends Controller {
	...
	public function getList()
	{
		...
		foreach ($pages as $key => $page_element) {
			$pages[$key]['delete'] = $this->url->link('content/page/delete&page_id='.$page_element['page_id'].'&category_id='.$page_element['category_id'], 'token=' . $this->session->data['token'], 'SSL');
			$pages[$key]['edit'] = $this->url->link('content/page/edit&page_id='.$page_element['page_id'], 'token=' . $this->session->data['token'], 'SSL');
		}
		...
		$pagination->url = $this->url->link('content/page&category_id='.$category_info['category_id'], 'token=' . $this->session->data['token']  . '&page={page}', 'SSL');
