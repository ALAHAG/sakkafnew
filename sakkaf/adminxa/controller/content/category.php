...
class ControllerContentCategory extends Controller {
	...
	public function getForm()
	{
		...
		$data['countries'] = $this->model_localisation_country->getCountries(array('status'  => 1));
		...
		if (isset($this->request->post['country_id'])) {
			...
			$data['country_id'] = $category_info['country_id'];
			$data['country_name'] = $this->model_localisation_country->getCountry($data['country_id'])['name_ar'];
		} else {
			$data['country_id'] = '';
		}
