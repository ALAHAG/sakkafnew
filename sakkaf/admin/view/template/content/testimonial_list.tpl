          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($information['testimonial_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $information['testimonial_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $information['testimonial_id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $information['name']; ?></td>
                  <td class="text-right"><?php echo $information['country_name']; ?></td>
