      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-filter" class="form-horizontal">
          ...
          <div class="form-group col-sm-12">
            <label class="col-sm-3 control-label" for="itinerary_notes"><?php echo $entry_itinerary_notes; ?></label>
            <div class="col-sm-9">
              ...
              <?php foreach ($itinerary as $key => $element):?>
                ...
                <div id="itinerary_element<?php echo $counter ?>" class="itinerary_element row">
                    ...
                    <div class="col-md-2">
                      ...
                      <img  width="100" id="tr_image<?php echo $counter ?>" src="<?php echo HTTP_IMAGE; ?><?php echo $element['transportation_image']; ?>" alt="" title="" data-placeholder="<?php echo HTTP_IMAGE; ?>no_image.png" />
                      </a>
        ...
        $('#addTransportation').click(function () {
          var transportation = '<div id="itinerary_element'+counter+'" class="itinerary_element row">'
            ...
            transportation +='<div class="row"><div class="col-lg-2">'
                              ...
                              +'<img id="tr_image'+counter+'" width="100" src="<?php echo HTTP_IMAGE; ?>no_image.png" alt="" title="" data-placeholder="<?php echo HTTP_IMAGE; ?>no_image.png" />'
                              +'</a>'
          ...
          $('.transportation').change(function() {
              ...
              $.ajax({
                ...
                success: function  (json) {
                  ...
                  $.each(JSON.parse(json),function(i,e){
                        if(id==e.id){
                          $("#tr_image"+counter).attr("src", '<?php echo HTTP_IMAGE; ?>'+ e.image);
          ...
          var tour = '<div id="itinerary_element'+counter+'" class="itinerary_element row">'
            ...
            tour +='<div class="row"><div class="col-lg-2">'
                            ...
                            +'<div class="col-lg-10">'
                              ...
                              +'</div></div></div><div class="row">'
                              // +'<div class="form-group col-md-4 col-sm-6">'
                              //   +'<label class="col-sm-6 control-label" for="num_of_tours"><?php echo $entry_num_of_tours; ?></label>'
                              //   +'<div class="col-sm-6">'
