...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['menu'] = $this->url->link('content/menu', 'token=' . $this->session->data['token'], 'SSL');
		$data['booking'] = $this->url->link('content/booking', 'token=' . $this->session->data['token'], 'SSL');
		$data['package'] = $this->url->link('content/itinerary/package', 'token=' . $this->session->data['token'], 'SSL');
		$data['quotation'] = $this->url->link('content/itinerary/quotation', 'token=' . $this->session->data['token'], 'SSL');
		$data['confirmation'] = $this->url->link('content/itinerary/confirmation', 'token=' . $this->session->data['token'], 'SSL');
		$data['slider'] = $this->url->link('content/slider', 'token=' . $this->session->data['token'], 'SSL');
		$data['testimonial'] = $this->url->link('content/testimonials', 'token=' . $this->session->data['token'], 'SSL');
		$data['gallery'] = $this->url->link('content/gallery', 'token=' . $this->session->data['token'], 'SSL');
		$data['hotels'] = $this->url->link('content/hotels', 'token=' . $this->session->data['token'], 'SSL');
		$data['tours'] = $this->url->link('content/tours', 'token=' . $this->session->data['token'], 'SSL');
		$data['page_category'] = $this->url->link('content/category&category_type=2', 'token=' . $this->session->data['token'], 'SSL');
		$data['package_category'] = $this->url->link('content/category&category_type=1', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->load->model('content/category'); //$arr('status' => 1 )
		$categories=array();
		$categories = $this->model_content_category->getAllData(2);

		foreach ($categories as $key => $value) {
			$categories[$key]['link'] = $this->url->link('content/page&category_id='.$value['category_id'], 'token=' . $this->session->data['token'], 'SSL');
		}
