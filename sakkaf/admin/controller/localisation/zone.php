...
class ControllerLocalisationZone extends Controller {
	...
	public function citiesByZoneId()
	{
		if(isset($this->request->post['zone_id'])){

			$this->load->model('localisation/zone');

			$cities = $this->model_localisation_zone->getCitiesByZoneId($this->request->post['zone_id']); // 129 => Malaysia
	...
	public function addCity()
	{
		if(isset($this->request->post)){
			...
			echo $this->model_localisation_zone->addCity($this->request->post); // 129 => Malaysia
