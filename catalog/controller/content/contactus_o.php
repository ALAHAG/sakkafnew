	...
	class ControllerContentContactus extends Controller {
		...
		public function index() {
			$this->document->setTitle('شركة السقاف للسياحة والسفر احدى  افخم واقدم شركات السياحة في ماليزيا ');
			$this->document->setDescription("خدمة العملاء والاستفسارات لشركة السقاف للسياحة والسفر في ماليزيا 24/7 على مدار الساعه او زيارة احدى المكاتب السياحية في كولالمبور ");//$this->config->get('config_meta_description')
			$this->document->setKeywords("شركو السقاف للسياحة والسفر ماليزيا ,شركة سياحة ماليزيا,شركات سياحية في ماليزيا, تواصل معنا ");//$this->config->get('config_meta_keyword')
