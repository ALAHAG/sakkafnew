...
class ControllerCommonHome extends Controller {
	public function index() {
		$this->document->setTitle("عروض سياحية الى ماليزيا لعام 2017 تقدمها شركة السقاف شاملة فنادق في مدن ماليزيا وجولات سياحية ومواصلات بين المدن الماليزيا باسعار منافسه ");//$this->config->get('config_meta_title')
		$this->document->setDescription("عروض سياحية ماليزيا لعام 2017 شاملة جولات سياحية وحجوزات فنادق ماليزيا و عروض برامج وبكجات شهر عسل وبرامج عائلية ماليزيا بسعر منافس رخيصه وفنادق 5 نجوم");//$this->config->get('config_meta_description')
		 $this->document->setKeywords("ماليزيا,السياحية في ماليزيا,عروض سياحية ,فضل شركة سياحة في ماليزيا,شركة عربية للسياحة في ماليزيا,برامج شهر عسل ,بكجات عائلية ,حجز رحلة الى ماليزيا , تذاكر ماليزيا , افضل مناطق ماليزيا");//$this->config->get('config_meta_keyword')
