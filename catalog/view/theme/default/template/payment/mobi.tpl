...
<form  method="post" id="payment" class="cruise-booking-form">
  ...
  <div class="col-md-12">
    ...
    <div class="form-group col-md-8 col-xs-8">
        ...
        <input class="input-text full-width" type="text" placeholder="الاسم بالانجليزي" name="nameOnCard" value="<?php echo isset($customer_data['customer_name']) ? $customer_data['customer_name'] : '';?>" required  />
      </div>

      <div class="form-group col-md-4 col-xs-4">
        <label> Booking ID</label>
        <input class="input-text full-width" type="text" id="ordrid" placeholder="رقم البرنامج"  name="ordrid" value="<?php echo isset($customer_data['package_ids']) ? $customer_data['package_ids'] : '';?>">
...
<div class="col-md-12">
  <div class="form-group col-md-12 col-xs-12">
    ...
    <input type="text" class="input-text full-width"  id="fee" name="fee" placeholder="10.00" value="<?php echo isset($customer_data['payment-option']) ? $customer_data['payment-option'] : '0.00';?>" required>
    <small id="amountHelper" class="form-text text-muted">
          <br/>Processing fee: <span id="processingFee">0.00</span><strong>MYR</strong>
    </small>
    <input type="hidden" class="form-control" id="amount" name="amount" placeholder="10.00" value="<?php echo isset($customer_data['taxes']) ? $customer_data['taxes'] : '0.00';?>" required></td>
  </div>
</div>
<div class="col-md-12 col-xs-12">
  <div class="form-group col-md-12 col-xs-12">
    <input type="submit" name="submit" value="<?php echo isset($customer_data['total_payment']) ? 'Pay Total amount: '.$customer_data['total_payment'].' MYR' : 'Pay';?>" id="button-confirm" class="full-width btn-large"></td>
  </div>
</div>
