    ...
    <tr>
      ...
      <input type="hidden" class="input-text full-width"  id="reference" name="reference" value="" required>
		...
		<tr>
			...
			<!-- <td><input class="input-text full-width" type="text" name="cardnum" value="" /></td> -->
...
<script>
  $(document).ready(function(){
    ...
    $("#btn-submit").val("Proceed to payment: " + amount.toFixed(2) + " MYR");
    ...
    $("#fee").keyup(function(){
      ...
      var processingFee =  amount - fee;
      $("#processingFee").text(processingFee.toFixed(2));
      $("#button-confirm").val("Total Payment: " + amount.toFixed(2) + " MYR");
