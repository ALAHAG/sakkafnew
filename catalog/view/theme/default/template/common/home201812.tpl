                                    ...
                                    <article class="box package" id="<?php echo $server.$package['slug'] ?>" itemscope itemtype="https://schema.org/Product" itemref="footer">
                                        <figure class="animated" data-animation-type="fadeInDown" data-animation-duration="1">
                                            <a itemprop="url"  href="<?php echo $server.$package['slug'] ?>" title="<?php echo $package['itinerary_title'] ?> - ماليزيا - عروض ماليزيا - فنادق ماليزيا" class="hover-effect">
                                                    <img src="<?php echo $package['image_thumb'] ?>"  title="<?php echo $package['itinerary_title'] ?>" alt="<?php echo $package['itinerary_title'] ?> - ماليزيا - عروض ماليزيا - فنادق ماليزيا"  /><span class="discount"><span class="discount-text">عرض جديد</span></span></a>
  ...
  <section>
    <div class="row image-box style1 add-clearfix">
      <div class="col-sms-12 col-sm-12 col-md-12 sgaf ">
        <a href="https://api.whatsapp.com/send?phone=60187770018" class=" "><i class=" float-right soap-icon-stories"></i>   للتواصل السريع مع مدير قسم الحجوزات عبر الواتس اب (<img src="image/whatsapp.png" title="alsakkaf travel" alt= "alsakkaf travel and Tours Malaysia"> 0060187770018) على مدار 24 ساعه</a>
      </div>
                            ...
                            <div class="vid-list-container">
                                  <div class="vid-list">
                                      <div class="vid-item" onClick="document.getElementById('vid_frame').src='https://youtube.com/embed/Vwb2xFKpuyQ?autoplay=1&rel=0&showinfo=0&autohide=1'">
                                        <div class="thumb"><img src="/image/youtube/1.jpg" width="128" height="96" alt="قالو عن شركة السقاف للسياحة والسفر ماليزيا" title="قالو عن شركة السقاف للسياحة والسفر ماليزيا"></div>
                                      ...
                                      <div class="vid-item" onClick="document.getElementById('vid_frame').src='https://youtube.com/embed/mbSK5ZT1NSs?autoplay=1&rel=0&showinfo=0&autohide=1'">
                                        <div class="thumb"><img src="/image/youtube/0.jpg" width="128" height="96" alt="قالو عن شركة السقاف للسياحة والسفر ماليزيا" title="قالو عن شركة السقاف للسياحة والسفر ماليزيا"></div>
                                      ...
                                      <div class="vid-item" onClick="document.getElementById('vid_frame').src='https://youtube.com/embed/M_-ybmbWKls?autoplay=1&rel=0&showinfo=0&autohide=1'">
                                        <div class="thumb"><img src="/image/youtube/2.jpg" width="128" height="96" alt="قالو عن شركة السقاف للسياحة والسفر ماليزيا" title="قالو عن شركة السقاف للسياحة والسفر ماليزيا"></div>
