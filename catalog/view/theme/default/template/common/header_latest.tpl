...
<meta name="twitter:site" content="@alsakkaftravel1" />
    ...
    <!-- Main Style -->
    <link id="main-style" rel="stylesheet" href="catalog/view/theme/default/stylesheet/style-purpuless.css">
    <!-- Custom Styles -->
    <link rel="stylesheet" href="catalog/view/theme/default/stylesheet/customs.css">
    <!-- Updated Styles -->
