...
<div class="page-title-container">
    <div class="container">
        <div class="page-title pull-left">
            <h2 class="entry-title" itemprop="name" ><?php echo $itinerary_title; ?></h2>
        </div>
    </div>
</div>
<section id="content" class="gray-area" >
    <div class="container car-detail-page" id="<?php echo $_SERVER['REQUEST_URI']; ?>" itemscope itemtype="http://schema.org/Product" itemref="footer">
        <div class="row">
            <div id="main" class="col-md-9">
                <div class="featured-image box">
                    <meta itemprop="name" content="<?php echo $itinerary_title; ?>">
                    <img src="<?php echo HTTP_IMAGE.$itinerary_image ?>" alt="<?php echo $itinerary_title; ?>" />
                    <meta itemprop="image" content="<?php echo HTTP_IMAGE.$itinerary_image ?>">

                    <div class="a"> <span itemprop="offers" itemscope itemtype="http://schema.org/Offer"><h2> السعر الاجمالي للبرنامج <br/> <div class="price" itemprop="priceCurrency" content="SAR"><span itemprop="price" content="<?php echo $customer_price ?>"><?php echo $customer_price ?> رنجت </span></div> <center><?php if($entry_num_passengers==2) {echo '[لشخصين]';} else{ echo '['.$entry_num_passengers.' أشخاص]'; }?></center></h2>  </span><span class="review price" itemprop="description"><span class="hidden"><?php echo $package['itinerary_title'] ?></span>  عدد الليالي : <?php echo $nights ?><small><?php if($nights>10){echo ' ليله و'; }else{ echo ' ليالي و';}?> </small>  <?php echo ($nights+1) ?><small><?php if($nights+1>10){echo ' يوم'; }else{ echo ' ايام';}?> </small></span> </div>
                </div>
                                     ...
                                     <?php foreach ($package_rooms as $room): ?>
                                        ...
                                        <div class="">
                                            <div class="col-xs-12 col-sm-3">
                                                <figure class="">
                                                    <span><img alt="" src="<?php echo HTTP_IMAGE.$room['image'] ?>" width="200"></span>
                                                </figure>
                                            </div>
        ...
        <!--  <li style="direction: ltr;"> +6018 777 0018</li>
         <li style="direction: ltr;"> +6018 777 0057</li><br/> -->
          <li class="phone" style="text-align: center;">
            واتس اب مباشر
            <br/><span class="contact-phone"  ><a href="https://api.whatsapp.com/send?phone=60187770018&text=' طلب برنامج - كود البرنامج  : B<?php echo $itinerary_id ?> '">0060187770018<img src="image/whatsapp.png"></a></span><br/>
            <span class="contact-phone"><a href="https://api.whatsapp.com/send?phone=60187770057&text=' طلب برنامج - كود البرنامج : B<?php echo $itinerary_id ?>'">0060187770057<img src="image/whatsapp.png"></a></span><br/>
            <div>
              اواتصال <br/>
