<?php echo $header; ?>
<!-- Google Code for Order package Conversion Page -->
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 995212828;
var google_conversion_language = "en";
var google_conversion_format = "2";
var google_conversion_color = "ffffff";
var google_conversion_label = "7OqMCN--924QnPzG2gM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/995212828/?label=7OqMCN--924QnPzG2gM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
                ...
                <div class="row">
                    <div id="main" class="col-sm-12 col-md-12 ">
                        <div class="booking-information travelo-box">
                            <h2><i class="soap-icon-check icon circle"></i> تم استلام طلبك بنجاح </h2>
                            <hr />
                            <div class="booking-confirmation detailed-logo note  clearfix">
                                <i class="soap-icon-recommend icon circle"></i>
                                <div class="message">
                                    <h4 class="main-message">شكرا لك .لقد تم إستلام طلبك بنجاح وسيقوم احد موظفي الحجوزات بالرد عليك .</h4>
                                    <p>سيتم التواصل بك على الايميل ورقم التلفون.</p>
                                </div>
                                <br/><br/><br/>
                            </div>
                      <!--       <hr />
                           ...
                           <!-- <article class="detailed-logo note heading-orange"> -->
                            ...
                            <br />
                          <a href="http://alsakkaftravel.net/terms" class="button  left btn-small uppercase">اضغط هنا لمعرفة طريقة الدفع لشركة السقاف للسياحة والسفر</a>
                        </div>
                    </div>
