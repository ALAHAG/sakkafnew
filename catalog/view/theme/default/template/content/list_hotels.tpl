						...
						<div class="col-md-6 wow zoomIn" data-wow-delay="0.1s">
							<div class="hotel_container">
								...
								<div class="img_container">
									<a href="<?php echo $server.$hotel['slug'] ?>">
										<img src="<?php echo $hotel['thumb'] ?>" width="800" height="533" class="img-fluid" alt="Image">
										<div class="score"><span><?php echo $hotel['star_rate'];?></span> نجوم</div>
								...
								<div class="hotel_title">
									<h3><strong><?php echo $hotel['hotel_name'] ?></strong> </h3>
									<div class="rating">
                    <span class="rating">
                      <?php if($hotel['star_rate'] == 5 ){ ?>
                      ...
                      <?php } if($hotel['star_rate'] == 4 ){ ?>
                        <i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i>              <i class=" icon-star-empty"></i>
                      <?php }  ?>
                    </div>
									<!-- end rating -->
									<div class="wishlist">
										<a class="tooltip_flip tooltip-effect-1" href="<?php echo $server.$hotel['slug'] ?>">+<span class="tooltip-content-flip"><span class="tooltip-back">للمزيد من التفاصيل</span></span></a>
									</div>
									<!-- End wish list-->
								</div>
							</div>
