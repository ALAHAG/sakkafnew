...
<li>ومن ثم تعبئة معلومات الحجز</li></ol> <br/> </div><br/>
          ...
          <div class="row image-box hotel listing-style1">
            <div class="hotels">
              ...
              <div class="car-list listing-style3 car">
                ...
                <article class="heading-oranges"
                  v-show="current_city == 'all' || current_city == '<?php echo $tour['city_id']; ?>'"
                  :class="isSelected(<?php echo $tour['id'] ?>) ? 'selected' : ''">
                  <table class="table table-bordered" width="100%">
                    <tr>
                      <td>
                        <img alt="" src="<?php echo $tour['thumb'] ?>" width="200">
                      </td>
                      <td>
                        <div class="col-sm-10 col-xs-12">
                          <div class="clearfix">
                            <h4 class="box-title "><a href="<?php echo $server.$tour['slug'] ?>" class=""><span
                                  class="skin-color"> </span><?php echo $tour['title_ar'] ?><small class="-color">
                                  <?php echo $tour['title_en'] ?>- المدينة : <?php echo $tour['city_name'];?>  </small></a></h4>
                          </div>

                          <div class="clearfix" style="font-size:.9em">
                          ...
                          <table class="table table-bordered" width="100%">
                            ...
                            <tr>
                              <td><?php echo $tour['carType'];?></td>
                              <td><?php echo $tour['city_name'];?>  </td>
                              <td><i> <?php echo $tour['selprice'];?> </i> رنجت</td>
                            </tr>
                          </table>
                        </div>
                  ...
                  <div class="">
                    ...
                    <div class="details col-xs-12 col-sm-1 clearfix">
                      ...
                      <b>  السعر <br/><i> <?php echo $tour['selprice'];?> </i> رنجت</b>
                      </div> -->
                  ...
                  <div class="details-car col-md-12 col-sm-12 ">

                    <!-- <div class="col-md-4">نوع المركبة : سيارة صغيرة</div>
                    <div class="col-md-4">المدينة : كولالمبور</div>
                    <div class="col-md-4">السعر : 500 رنجت</div> -->
                 </div>
               </div>
             </div>
          ...
          <div v-show="cart.length" style="display: none;">
            ...
            <ul class="list-group">
              <li class="list-group-item clearfix" v-for="(tour, index) in cart" :key="index">
                ...
                <br />
                <small>{{ tour.selprice }} رنجت</small>
      ...
      <div id="step2" class="col-md-7" style="display:none">
        <h4>تفاصيل الحجز</h4>
  ...
  methods: {
    ...
    book : function (e) {
      ...
      $.ajax({
            ...
            data: { ...this.customer_info, tours : this.cart , booking_type: 'tours88'},
  ...
  computed: {
    total_price: function() {
      ...
      for (const tour of this.cart) {
        price += parseFloat(tour.selprice);
      }
      return price;
    }
  },
