...
<div class="page-title-container">
  <div class="container">
    <div class="page-title pull-left">
      <h2 class="entry-title">المواصلات والجولات السياحية في ماليزيا</h2>
    </div>
  </div>
</div>
<section id="content">
                      ...
                      <div class="col-sm-8 col-xs-12">
                        <div class="clearfix">
                          <h4 class="box-title white-color"><a href="<?php echo $server.$tour['slug'] ?>" class=""><span
                                ...
                                <?php echo $tour['title_en'] ?></small></a></h4>
                        </div>
  ...
  methods: {
    ...
    book : function (e) {
      ...
      $.ajax({
            ...
            data: { ...this.customer_info, tours : this.cart , booking_type: 88},
