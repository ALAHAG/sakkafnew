...
class Mail {
	...
	public function send() {
		...
		if ($this->protocol == 'mail') {
			...
			if ($this->parameter) {
				// Log_Mail($header_log = $header, $to_log = $to, $subject_log = $this->subject, $message_log = $message, $parameter_log = $this->parameter, $html_log = $this->html,$from_log = $this->from);//logging
