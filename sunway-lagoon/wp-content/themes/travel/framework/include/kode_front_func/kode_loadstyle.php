<?php
	...
	*/	session_start();
		...
		function kode_generate_style_custom( $options ){
			...
			if(isset($theme_option['logo-bottom-margin'])){
			if($theme_option['logo-bottom-margin'] <> ''){
				$style .= '.logo{';
				$style .= 'margin-bottom: ' . $theme_option['logo-bottom-margin'] . 'px;  }' . "\r\n";
			}
			}
			
			if(isset($theme_option['logo-top-margin'])){
			if($theme_option['logo-top-margin'] <> ''){
				$style .= '.logo{';
				$style .= 'margin-top: ' . $theme_option['logo-top-margin'] . 'px;  }' . "\r\n";
			}
			}
