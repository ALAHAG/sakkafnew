							...
							'options' => array(
								...
								'layout-style' => array(
									...
									'options' => array(
										...
										'enable-rtl-mode' => array(
											'title' => __('Enable RTL', 'kode_forest'),
											'type' => 'checkbox',	
											'default' => 'enable'
										),										
									)
								...
								'analytics-scriptstyle' => array(
									'title' => __('Analytics', 'kode_forest'),
									'options' => array(			
										'google-analytics' => array(
											'title' => __('Analytic Script ( with the &lt;script> tag )', 'kode_forest'),
											'type' => 'textarea',	
											'class' => 'full-width',
										),		
									)
