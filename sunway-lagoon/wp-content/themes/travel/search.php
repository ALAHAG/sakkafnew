						...
						<div class="row">
							<div class="col-md-12">
								<div class="kd-404 widget widget_search kode-widget">
									<h2><?php esc_attr_e('Not Found', 'kode_forest'); ?></h2>
									<span><?php esc_attr_e('OPS, PAGE NOT FOUND', 'kode_forest'); ?></span>
									<p><?php esc_attr_e('Nothing matched your search criteria. Please try again with different keywords.', 'kode_forest'); ?></p>
